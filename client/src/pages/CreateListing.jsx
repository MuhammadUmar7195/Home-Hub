        ...
        <div className="flex flex-col flex-1 gap-4">
          <p className="font-semibold">
            ...
            <span className="font-normal text-gray-600 ml-2">
              The first image will be the cover (max 6 MB)
            </span>
          </p>
          <div className="flex gap-4 rounded-lg">
            <input
              ...
              multiple
            />
            <button className="p-3 text-green-700 border bg-white border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80">
              Upload
            </button>
          </div>
